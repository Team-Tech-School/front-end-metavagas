...
export const InfoJobs = ({page, newVacancy}: InfoJobsProps) => {
  return (
    <S.ResultInfoJobsDiv>
      ...
      <S.ContainerFooter>
        <S.Container>
            <S.StyledText page={page}> <img src={Cifrao} alt="cifrão" /> Faixa Salarial: <S.BoldText>R$ 4.000,00</S.BoldText></S.StyledText>
            <S.StyledText page={page}> <img src={Local} alt="Localização" /> Localização: <S.BoldText>Belo Horizonte</S.BoldText></S.StyledText>
            <S.StyledText page={page}> <img src={Computer} alt="Tipo de vaga" /> Tipo de vaga: <S.BoldText>Home office</S.BoldText></S.StyledText>
